...
void setup()
{
  ...
  pinMode(TASTER3_LED_PIN, OUTPUT);
  digitalWrite(TASTER3_LED_PIN, LOW);
...
void loop()
{
  ...
  if (digitalRead(TASTER3_PIN) == TASTER_GEDRUECKT)
  {
    ...
    else
    {
      ...
      starteLampen();
      digitalWrite(TASTER3_LED_PIN, HIGH);
    }
